...
public class DataUtil {
    ...
    public static String periodoEmTexto(int dias) {
        ...
        String dataFormatadaIta = formatoBrasileiro.format(dataIda.getTime());
        String dataFormatadaVolta = formatoBrasileiro.format(dataVolta.getTime());
        String dataFormatadaDaViagem = dataFormatadaIta + " - " + dataFormatadaVolta + " de " + dataVolta.get(Calendar.YEAR);
